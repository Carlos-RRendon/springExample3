package com.FirstServer.App.springairline.model;
...
public class Flight {
    ...
    public Flight(Aircraft aircraft, Long flightCode, String origin, String destiny, Map<String,Passenger>passengers, String info){
